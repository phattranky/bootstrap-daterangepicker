...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        updateMonthsInView: function() {
            ...
            // For non-linked date-range picker, if year-month of startDate, endDate and maxDate are same, then rendering that year-month in rightCalendar and showing previous month in leftCalendar for better UX.
            if(!this.linkedCalendars && !this.singleDatePicker && this.maxDate && this.startDate && this.endDate
              && this.startDate.format('YYYY-MM') === this.endDate.format('YYYY-MM') && this.maxDate.format('YYYY-MM') === this.endDate.format('YYYY-MM')) {
